...
*
* added isSessionResumptionSupported()
* code copied from: https://github.com/jitsi/strophejs-plugin-stream-management
*
* TAKE CARE:
* - added "BINDREQUIRED: number" and "ATTACHFAIL: number" to IStatus above! AND
* - added some things to ../../node_modules/@types/strophe.js/index.d.ts:
*   > add BINDREQUIRED, ATTACHFAIL to "enum Status" in "namespace Strophe"
*   > add function addConnectionPlugin(name: string, ptype: any):void; to "namespace Strophe"
*/
...
Strophe.addConnectionPlugin('streamManagement', {
    ...
    */
    ...
    isSessionResumptionSupported() {
        return this._resumeToken !== undefined;
    },
    ...
    */
    ...
    _handleEnabled: function(elem) {
        ...
        this._resumeToken = (elem.getAttribute('resume') === 'true' || elem.getAttribute('resume') === '1') && elem.getAttribute('id');
    ...
    _handleResumed: function(elem) {
        ...
        if (this._unacknowledgedStanzas.length > 0) {
            this.logging && Strophe.debug('SM Sending unacknowledged stanzas');
            for(const stanza of this._unacknowledgedStanzas) {
                this._c.send(stanza);
            }
        } else {
            this.logging && Strophe.debug('SM No unacknowledged stanzas');
        }
